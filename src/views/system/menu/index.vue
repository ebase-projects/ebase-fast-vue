...
import { saveMenu, getMenuTree, updateMenu, deleteMenu } from '@/api/system/menu'
...
export default {
  ...
  methods: {
    ...
    handleEdit: function(row) {
      ...
      this.dialogVisible = true
      const { menuId, type, name, parentId, parentName, isFrame, component, url, perms, sort, icon } = row
    ...
    handleTreeSelectChange(data) {
      console.log('----handleTreeSelectChange---' + data)
